...
class SalaryPayrollBatchProcessor
{
    ...
    private function entryPayload(int $runId, int $employeeId, array $result, bool $applyAttendanceExtra = false, bool $includeKeys = true): array
    {
        $payload = [
            ...
            'pf_admin_employer' => $result['pf_admin_employer'] ?? 0,
            'pf_challan_ac1' => $result['pf_challan_ac1'] ?? 0,
            'pf_challan_ac2' => $result['pf_challan_ac2'] ?? 0,
            'pf_challan_ac10' => $result['pf_challan_ac10'] ?? 0,
            'pf_challan_total' => $result['pf_challan_total'] ?? 0,
