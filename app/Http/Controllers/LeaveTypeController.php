...
class LeaveTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Branches list only needed for super admin if bypassing scope, but we enforcing scope
        // So remove branches list passed to frontend to avoid confusion
    ...
    public function store(Request $request)
    {
        ...
        // Check if leave type with same name already exists in the same branch
        // HasBranch scope should handle this automatically if we use ::where?
        // But we need to check existence. 
        // If we use LeaveType::where(...), global scope is applied.
    ...
    public function update(Request $request, $leaveTypeId)
    {
        ...
        if ($leaveType) {
            try {
                ...
                // Check if leave type with same name already exists (excluding current) in the same branch
