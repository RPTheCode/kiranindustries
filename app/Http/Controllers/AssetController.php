...
class AssetController extends Controller
{
    ...
    {
        // HasBranch trait automatically scopes the query to active branch
        ...
        // These might be global, but typically we want types available to this company
    ...
    public function store(Request $request)
    {
        ...
        $assetData = [
            ...
            'branch_id' => session('active_branch_id'), // Explicitly set branch_id
    ...
    public function exportDepreciationCsv(Request $request)
    {
        ...
        foreach ($assets as $asset) {
            ...
            $csvData[] = [
                ...
                number_format((float) ($depreciation->current_value ?? 0), 2),
                number_format((float) (($asset->purchase_cost ?? 0) - ($depreciation->current_value ?? 0)), 2),
