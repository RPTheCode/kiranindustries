        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="deduction-section" style="width: 45%;">DEDUCTION PARTICULARS</th>
                    <th class="deduction-section" style="width: 20%;">TOTAL DEDUCTION</th>
                </tr>
            </thead>
            <tbody>
                @php 
                ...
                @foreach($reportData as $deptName => $rows)
                    ...
                    @foreach($rows as $row)
                        ...
                        <tr class="{{ $sr % 2 == 0 ? 'row-alt' : '' }}">
                            ...
                            <td class="text-right font-bold deduction-section" style="vertical-align: middle;">Rs. {{ number_format((float)$row['total_deduction'], 2) }}</td>
                        </tr>
                    @endforeach
                @endforeach
            </tbody>
            <tfoot>
                <tr class="total-row" style="background-color: #f1f5f9;">
                    ...
                    <td class="text-right font-bold deduction-section" style="vertical-align: middle;">Rs. {{ number_format($colTotals['total_deduction'], 2) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
