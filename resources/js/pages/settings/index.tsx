...
export default function Settings() {
  ...
  const sidebarNavItems = allSidebarNavItems.filter(item => {
    ...
    if (auth.user && auth.user.type === 'company') {
      ...
      if (!isSaas) {
        allowedPermissions.push('manage-storage-settings', 'manage-recaptcha-settings', 'manage-cache-settings');
        // Hidden for company: 'manage-chatgpt-settings', 'manage-cookie-settings', 'manage-seo-settings'
      }
