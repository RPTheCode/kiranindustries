...
>(({ onOpenChange, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Root modal={true} {...props} onOpenChange={handleOpenChange} />
  );
})
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        isFirstModal ? "bg-black/30 backdrop-blur-sm" : "bg-black/20 backdrop-blur-[1px]",
        className
      )}
      style={{ zIndex }}
      {...props}
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { modalId?: string; hideClose?: boolean }
>(({ className, children, modalId, hideClose, ...props }, ref) => {
  ...
  console.log('[DialogContent] Mounting/Rendering', { currentModalId, modalStack });
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(e) => {
          // Allow clicks on popovers/comboboxes that are in portals
