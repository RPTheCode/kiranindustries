...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::get('payslips', fn () => redirect()->route('hr.salary-payroll.payslips.index'))->name('hr.payslips.index');
    Route::get('payslips/{any}', fn () => redirect()->route('hr.salary-payroll.payslips.index'))->where('any', '.*');
    ...
    Route::post('payroll/earning-deduction-entry/store', [\App\Http\Controllers\MonthlyIncentiveController::class, 'store'])->middleware('permission:create-earning-deduction-entry|edit-earning-deduction-entry|manage-earning-deduction-entry|manage-any-earning-deduction-entry')->name('hr.earning-deduction.store');
    $salaryAdvancePerms = 'view-salary-advances|create-salary-advances|edit-salary-advances|delete-salary-advances|manage-salary-advances|manage-any-salary-advances';
    Route::get('payroll/salary-advances/employee-eligibility/{userId}', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'eligibility'])->middleware('permission:'.$salaryAdvancePerms)->name('hr.salary-advances.eligibility');
    Route::get('payroll/salary-advances', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'index'])->middleware('permission:'.$salaryAdvancePerms)->name('hr.salary-advances.index');
    Route::get('payroll/salary-advances/print-blank', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'printBlank'])->middleware('permission:'.$salaryAdvancePerms)->name('hr.salary-advances.print-blank');
    Route::get('payroll/salary-advances/create', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'create'])->middleware('permission:create-salary-advances|manage-salary-advances|manage-any-salary-advances')->name('hr.salary-advances.create');
    Route::post('payroll/salary-advances', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'store'])->middleware('permission:create-salary-advances|manage-salary-advances|manage-any-salary-advances')->name('hr.salary-advances.store');
    Route::get('payroll/salary-advances/{salaryAdvanceRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'show'])->middleware('permission:'.$salaryAdvancePerms)->name('hr.salary-advances.show');
    Route::get('payroll/salary-advances/{salaryAdvanceRequest}/edit', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'edit'])->middleware('permission:edit-salary-advances|manage-salary-advances|manage-any-salary-advances')->name('hr.salary-advances.edit');
    Route::put('payroll/salary-advances/{salaryAdvanceRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'update'])->middleware('permission:edit-salary-advances|manage-salary-advances|manage-any-salary-advances')->name('hr.salary-advances.update');
    Route::delete('payroll/salary-advances/{salaryAdvanceRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'destroy'])->middleware('permission:delete-salary-advances|manage-salary-advances|manage-any-salary-advances')->name('hr.salary-advances.destroy');
    Route::post('payroll/salary-advances/{salaryAdvanceRequest}/approve', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'approve'])->middleware('permission:manage-salary-advances|manage-any-salary-advances|edit-salary-advances')->name('hr.salary-advances.approve');
    Route::post('payroll/salary-advances/{salaryAdvanceRequest}/disburse', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'disburse'])->middleware('permission:manage-salary-advances|manage-any-salary-advances|edit-salary-advances')->name('hr.salary-advances.disburse');
    Route::get('payroll/salary-advances/{salaryAdvanceRequest}/print', [\App\Http\Controllers\SalaryPayroll\SalaryAdvanceController::class, 'print'])->middleware('permission:'.$salaryAdvancePerms)->name('hr.salary-advances.print');
    $salaryLoanPerms = 'view-salary-loans|create-salary-loans|edit-salary-loans|delete-salary-loans|manage-salary-loans|manage-any-salary-loans';
    Route::get('payroll/salary-loans/employee-eligibility/{userId}', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'eligibility'])->middleware('permission:'.$salaryLoanPerms)->name('hr.salary-loans.eligibility');
    Route::get('payroll/salary-loans', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'index'])->middleware('permission:'.$salaryLoanPerms)->name('hr.salary-loans.index');
    Route::get('payroll/salary-loans/print-blank', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'printBlank'])->middleware('permission:'.$salaryLoanPerms)->name('hr.salary-loans.print-blank');
    Route::get('payroll/salary-loans/create', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'create'])->middleware('permission:create-salary-loans|manage-salary-loans|manage-any-salary-loans')->name('hr.salary-loans.create');
    Route::post('payroll/salary-loans', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'store'])->middleware('permission:create-salary-loans|manage-salary-loans|manage-any-salary-loans')->name('hr.salary-loans.store');
    Route::get('payroll/salary-loans/{salaryLoanRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'show'])->middleware('permission:'.$salaryLoanPerms)->name('hr.salary-loans.show');
    Route::get('payroll/salary-loans/{salaryLoanRequest}/edit', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'edit'])->middleware('permission:edit-salary-loans|manage-salary-loans|manage-any-salary-loans')->name('hr.salary-loans.edit');
    Route::put('payroll/salary-loans/{salaryLoanRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'update'])->middleware('permission:edit-salary-loans|manage-salary-loans|manage-any-salary-loans')->name('hr.salary-loans.update');
    Route::delete('payroll/salary-loans/{salaryLoanRequest}', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'destroy'])->middleware('permission:delete-salary-loans|manage-salary-loans|manage-any-salary-loans')->name('hr.salary-loans.destroy');
    Route::post('payroll/salary-loans/{salaryLoanRequest}/approve', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'approve'])->middleware('permission:manage-salary-loans|manage-any-salary-loans|edit-salary-loans')->name('hr.salary-loans.approve');
    Route::post('payroll/salary-loans/{salaryLoanRequest}/disburse', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'disburse'])->middleware('permission:manage-salary-loans|manage-any-salary-loans|edit-salary-loans')->name('hr.salary-loans.disburse');
    Route::get('payroll/salary-loans/{salaryLoanRequest}/print', [\App\Http\Controllers\SalaryPayroll\SalaryLoanController::class, 'print'])->middleware('permission:'.$salaryLoanPerms)->name('hr.salary-loans.print');
    Route::get('payroll/employee-salary', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'index'])->middleware('permission:view-salary-payroll-employee-salary|manage-salary-payroll-employee-salary|manage-any-salary-payroll-employee-salary|manage-own-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.employee-salary.index');
    Route::post('payroll/employee-salary/calculate', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'calculate'])->middleware('permission:view-salary-payroll-employee-salary|manage-salary-payroll-employee-salary|manage-any-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|create-salary-payroll-employee-salary|create-employee-salaries|edit-salary-payroll-employee-salary|edit-employee-salaries')->name('hr.salary-payroll.employee-salary.calculate');
    Route::post('payroll/employee-salary', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'store'])->middleware('permission:create-salary-payroll-employee-salary|create-employee-salaries|edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries|manage-any-salary-payroll-employee-salary|manage-any-employee-salaries')->name('hr.salary-payroll.employee-salary.store');
    Route::put('payroll/employee-salary/{employeeSalary}', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'update'])->middleware('permission:edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries|manage-any-salary-payroll-employee-salary|manage-own-salary-payroll-employee-salary|manage-own-employee-salaries')->name('hr.salary-payroll.employee-salary.update');
    Route::post('payroll/employee-salary/bulk', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'bulkStore'])->middleware('permission:create-salary-payroll-employee-salary|create-employee-salaries|edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.employee-salary.bulk');
    Route::get('payroll/employee-salary/{employee}/history', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'history'])->middleware('permission:view-salary-payroll-employee-salary|manage-salary-payroll-employee-salary|manage-any-salary-payroll-employee-salary|manage-own-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.employee-salary.history');
    Route::post('payroll/employee-salary/{employee}/increment', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'increment'])->middleware('permission:create-salary-payroll-employee-salary|create-employee-salaries|edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries')->name('hr.salary-payroll.employee-salary.increment');
    Route::post('payroll/employee-salary/{employee}/components', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'updateComponents'])->middleware('permission:edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries|manage-any-salary-payroll-employee-salary|manage-own-employee-salaries')->name('hr.salary-payroll.employee-salary.components');
    Route::patch('payroll/employee-salary/{employee}/daily-option', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'updateDailyOption'])->middleware('permission:edit-salary-payroll-employee-salary|edit-employee-salaries|manage-salary-payroll-employee-salary|manage-employee-salaries|manage-any-salary-payroll-employee-salary|manage-own-employee-salaries')->name('hr.salary-payroll.employee-salary.daily-option');
    Route::get('payroll/salary-increment', [\App\Http\Controllers\SalaryPayrollIncrementController::class, 'index'])->middleware('permission:view-salary-payroll-increment|manage-salary-payroll-increment|manage-any-salary-payroll-increment|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.salary-increment.index');
    Route::post('payroll/salary-increment/preview', [\App\Http\Controllers\SalaryPayrollIncrementController::class, 'preview'])->middleware('permission:view-salary-payroll-increment|manage-salary-payroll-increment|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|create-salary-payroll-increment|create-employee-salaries|edit-employee-salaries')->name('hr.salary-payroll.salary-increment.preview');
    Route::post('payroll/salary-increment/apply', [\App\Http\Controllers\SalaryPayrollIncrementController::class, 'apply'])->middleware('permission:create-salary-payroll-increment|create-employee-salaries|edit-employee-salaries|manage-salary-payroll-increment|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.salary-increment.apply');
    Route::get('payroll/payslips', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'index'])->middleware('permission:view-payslips|manage-payslips|download-payslips|view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.payslips.index');
    Route::get('payroll/payslips/{salaryPayrollRun}/entries/{salaryPayrollEntry}/preview', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'preview'])->middleware('permission:view-payslips|manage-payslips|download-payslips|view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.payslips.preview');
    Route::get('payroll/payslips/{salaryPayrollRun}/entries/{salaryPayrollEntry}/download', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'download'])->middleware('permission:download-payslips|manage-payslips|manage-any-payslips|view-payslips|finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.payslips.download');
    Route::get('payroll/generate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'index'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|edit-salary-payroll-runs|delete-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.index');
    Route::get('payroll/generate/create', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'create'])->middleware('permission:create-salary-payroll-runs|edit-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-salary-payroll-employee-salary|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.create');
    Route::post('payroll/generate/preview', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'preview'])->middleware('permission:create-salary-payroll-runs|view-salary-payroll-runs|manage-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|create-employee-salaries|edit-employee-salaries')->name('hr.salary-payroll.generate.preview');
    Route::post('payroll/generate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'store'])->middleware('permission:create-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.store');
    Route::get('payroll/generate/{salaryPayrollRun}/edit', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'edit'])->middleware('permission:create-salary-payroll-runs|edit-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.edit');
    Route::put('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'update'])->middleware('permission:create-salary-payroll-runs|edit-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.update');
    Route::post('payroll/generate/{salaryPayrollRun}/regenerate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'regenerate'])->middleware('permission:create-salary-payroll-runs|edit-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.regenerate');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/regenerate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'regenerateEntry'])->middleware('permission:create-salary-payroll-runs|edit-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.regenerate-entry');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/toggle-attendance-extra', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'toggleApplyAttendanceExtra'])->middleware('permission:apply-salary-payroll-attendance-extra|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.toggle-attendance-extra');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/clear-mispunch', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'clearEntryMispunch'])->middleware('permission:finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries|edit-salary-payroll-runs')->name('hr.salary-payroll.generate.clear-entry-mispunch');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/lock', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'lockEntry'])->middleware('permission:finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.lock-entry');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/unlock', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'unlockEntry'])->middleware('permission:finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.unlock-entry');
    Route::get('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/payslip', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadPayslip'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries|view-salary-payroll-employee-salary')->name('hr.salary-payroll.generate.download-payslip');
    Route::get('payroll/generate/{salaryPayrollRun}/payslips/download-all', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadAllPayslips'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries|view-salary-payroll-employee-salary')->name('hr.salary-payroll.generate.download-all-payslips');
    Route::post('payroll/generate/{salaryPayrollRun}/register/export', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadRegister'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries|view-salary-payroll-employee-salary')->name('hr.salary-payroll.generate.register.export');
    Route::get('payroll/generate/{salaryPayrollRun}/register', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'register'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|edit-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.register');
    Route::get('payroll/generate/{salaryPayrollRun}/challan-report', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'challanReport'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|edit-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.challan-report');
    Route::post('payroll/generate/{salaryPayrollRun}/challan-report/export', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadChallanReport'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries|view-salary-payroll-employee-salary')->name('hr.salary-payroll.generate.challan-report.export');
    Route::get('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'show'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|edit-salary-payroll-runs|finalize-salary-payroll-runs|manage-salary-payroll-runs|view-salary-payroll-employee-salary|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.show');
    Route::post('payroll/generate/{salaryPayrollRun}/finalize', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'finalize'])->middleware('permission:finalize-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.finalize');
    Route::delete('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'destroy'])->middleware('permission:delete-salary-payroll-runs|create-salary-payroll-runs|manage-salary-payroll-runs|manage-any-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.destroy');
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::post('deduction-types/reorder', [\App\Http\Controllers\DeductionTypeController::class, 'reorder'])->middleware('permission:edit-deduction-types|manage-deduction-types|manage-any-deduction-types|manage-own-deduction-types')->name('hr.deduction-types.reorder');
        Route::post('deduction-types/bulk-copy', [\App\Http\Controllers\DeductionTypeController::class, 'bulkCopyToBranches'])->middleware('permission:create-deduction-types|edit-deduction-types|manage-deduction-types|manage-any-deduction-types')->name('hr.deduction-types.bulk-copy');
        Route::post('deduction-types/{deduction_type}/copy-to-branches', [\App\Http\Controllers\DeductionTypeController::class, 'copyToBranches'])->middleware('permission:create-deduction-types|edit-deduction-types|manage-deduction-types|manage-any-deduction-types')->name('hr.deduction-types.copy-to-branches');
        Route::put('deduction-types/{deduction_type}/toggle-status', [\App\Http\Controllers\DeductionTypeController::class, 'toggleStatus'])->middleware('permission:edit-deduction-types|manage-deduction-types|manage-any-deduction-types|manage-own-deduction-types')->name('hr.deduction-types.toggle-status');
        ...
        Route::get('deduction-types', [\App\Http\Controllers\DeductionTypeController::class, 'index'])->middleware('permission:view-deduction-types|manage-deduction-types|manage-any-deduction-types|manage-own-deduction-types|create-deduction-types|edit-deduction-types|delete-deduction-types')->name('hr.deduction-types.index');
        Route::post('deduction-types', [\App\Http\Controllers\DeductionTypeController::class, 'store'])->middleware('permission:create-deduction-types|manage-deduction-types|manage-any-deduction-types')->name('hr.deduction-types.store');
        Route::put('deduction-types/{deduction_type}', [\App\Http\Controllers\DeductionTypeController::class, 'update'])->middleware('permission:edit-deduction-types|manage-deduction-types|manage-any-deduction-types|manage-own-deduction-types')->name('hr.deduction-types.update');
        Route::delete('deduction-types/{deduction_type}', [\App\Http\Controllers\DeductionTypeController::class, 'destroy'])->middleware('permission:delete-deduction-types|manage-deduction-types|manage-any-deduction-types')->name('hr.deduction-types.destroy');
        ...
        Route::get('payroll-settings', [\App\Http\Controllers\PayrollSettingController::class, 'index'])->middleware('permission:view-payroll-settings|manage-payroll-settings|edit-payroll-settings|manage-settings|view-settings')->name('hr.payroll-settings.index');
        ...
        Route::middleware('permission:manage-skills')->group(function () {
            ...
            Route::post('skills/wage-rates', [\App\Http\Controllers\SkillController::class, 'saveWageRates'])->middleware('permission:edit-skills')->name('hr.skills.wage-rates.save');
            ...
            Route::post('wage-zones', [\App\Http\Controllers\WageZoneController::class, 'store'])->middleware('permission:create-skills')->name('hr.wage-zones.store');
            Route::put('wage-zones/{wageZone}', [\App\Http\Controllers\WageZoneController::class, 'update'])->middleware('permission:edit-skills')->name('hr.wage-zones.update');
            Route::delete('wage-zones/{wageZone}', [\App\Http\Controllers\WageZoneController::class, 'destroy'])->middleware('permission:delete-skills')->name('hr.wage-zones.destroy');
            Route::put('wage-zones/{wageZone}/toggle-status', [\App\Http\Controllers\WageZoneController::class, 'toggleStatus'])->middleware('permission:edit-skills')->name('hr.wage-zones.toggle-status');
        });
        ...
        Route::get('salary-components', [\App\Http\Controllers\SalaryComponentController::class, 'index'])->middleware('permission:view-salary-components|manage-salary-components|manage-any-salary-components|manage-own-salary-components|create-salary-components|edit-salary-components|delete-salary-components')->name('hr.salary-components.index');
        Route::post('salary-components', [\App\Http\Controllers\SalaryComponentController::class, 'store'])->middleware('permission:create-salary-components|manage-salary-components|manage-any-salary-components')->name('hr.salary-components.store');
        Route::put('salary-components/{salaryComponent}', [\App\Http\Controllers\SalaryComponentController::class, 'update'])->middleware('permission:edit-salary-components|manage-salary-components|manage-any-salary-components|manage-own-salary-components')->name('hr.salary-components.update');
        Route::delete('salary-components/{salaryComponent}', [\App\Http\Controllers\SalaryComponentController::class, 'destroy'])->middleware('permission:delete-salary-components|manage-salary-components|manage-any-salary-components')->name('hr.salary-components.destroy');
