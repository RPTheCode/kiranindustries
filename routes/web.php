...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::post('payroll/employee-salary/{employee}/components', [\App\Http\Controllers\SalaryPayrollEmployeeSalaryController::class, 'updateComponents'])->middleware('permission:edit-employee-salaries|manage-employee-salaries')->name('hr.salary-payroll.employee-salary.components');
    ...
    Route::get('payroll/generate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'index'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|finalize-salary-payroll-runs|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.index');
    Route::get('payroll/generate/create', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'create'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.create');
    Route::post('payroll/generate/preview', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'preview'])->middleware('permission:create-salary-payroll-runs|view-salary-payroll-runs|view-employee-salaries|manage-employee-salaries|create-employee-salaries|edit-employee-salaries')->name('hr.salary-payroll.generate.preview');
    Route::post('payroll/generate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'store'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.store');
    Route::get('payroll/generate/{salaryPayrollRun}/edit', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'edit'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.edit');
    Route::put('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'update'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.update');
    Route::post('payroll/generate/{salaryPayrollRun}/regenerate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'regenerate'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.regenerate');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/regenerate', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'regenerateEntry'])->middleware('permission:create-salary-payroll-runs|create-employee-salaries|edit-employee-salaries|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.regenerate-entry');
    Route::post('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/lock', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'lockEntry'])->middleware('permission:finalize-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.lock-entry');
    Route::get('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/payslip', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadPayslip'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries')->name('hr.salary-payroll.generate.download-payslip');
    Route::get('payroll/generate/{salaryPayrollRun}/payslips/download-all', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadAllPayslips'])->middleware('permission:view-salary-payroll-runs|finalize-salary-payroll-runs|download-payslips|manage-employee-salaries|manage-any-employee-salaries|view-employee-salaries')->name('hr.salary-payroll.generate.download-all-payslips');
    Route::get('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'show'])->middleware('permission:view-salary-payroll-runs|create-salary-payroll-runs|finalize-salary-payroll-runs|view-employee-salaries|manage-employee-salaries|manage-any-employee-salaries|manage-own-employee-salaries')->name('hr.salary-payroll.generate.show');
    Route::post('payroll/generate/{salaryPayrollRun}/finalize', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'finalize'])->middleware('permission:finalize-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.finalize');
    Route::delete('payroll/generate/{salaryPayrollRun}', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'destroy'])->middleware('permission:create-salary-payroll-runs|manage-employee-salaries|manage-any-employee-salaries')->name('hr.salary-payroll.generate.destroy');
