...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('permission:view-payslips|manage-payslips|manage-any-payslips|manage-own-payslips|download-payslips|create-payslips|send-payslips')->group(function () {
        Route::get('payroll/payslips', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'index'])->name('hr.salary-payroll.payslips.index');
        Route::get('payroll/payslips/{salaryPayrollRun}/entries/{salaryPayrollEntry}/preview', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'preview'])->name('hr.salary-payroll.payslips.preview');
        Route::get('payroll/payslips/{salaryPayrollRun}/entries/{salaryPayrollEntry}/download', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollPayslipController::class, 'download'])->middleware('permission:download-payslips|manage-payslips|manage-any-payslips|manage-own-payslips|create-payslips')->name('hr.salary-payroll.payslips.download');
    });
    ...
    Route::get('payroll/generate/{salaryPayrollRun}/entries/{salaryPayrollEntry}/payslip', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadPayslip'])->middleware('permission:download-payslips|manage-payslips|manage-any-payslips|manage-own-payslips|create-payslips')->name('hr.salary-payroll.generate.download-payslip');
    Route::get('payroll/generate/{salaryPayrollRun}/payslips/download-all', [\App\Http\Controllers\SalaryPayroll\SalaryPayrollGenerateController::class, 'downloadAllPayslips'])->middleware('permission:download-payslips|manage-payslips|manage-any-payslips|create-payslips')->name('hr.salary-payroll.generate.download-all-payslips');
